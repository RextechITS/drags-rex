        ...
        <header className="w-full fixed px-6 lg:px-[200px] md:py-6 bg-[#00c0ff] text-white p-4 flex justify-between items-center z-50">
            ...
            <nav className={`md:hidden absolute w-full h-[100vh] top-16 left-0 bg-[#3a2b71] px-5 backdrop-blur-3xl transform transition-all duration-700 ease-in-out 
                ...
                <ul className="flex flex-col gap-4 mt-2" >
                    <li><NavLink to="/" className={({ isActive }) => isActive ? " text-[#00c0ff] underline underline-offset-8 font-bold" : ""} onClick={() => setIsOpen(false)}>Home</NavLink></li>
                    <li><NavLink to="/about" className={({ isActive }) => isActive ? "text-[#00c0ff] underline underline-offset-8 font-bold" : ""} onClick={() => setIsOpen(false)}>About</NavLink></li>
                    <li><NavLink to="/projects" className={({ isActive }) => isActive ? "text-[#00c0ff] underline underline-offset-8 font-bold" : ""} onClick={() => setIsOpen(false)}>Projects</NavLink></li>
                    <li><NavLink to="/contact" className={({ isActive }) => isActive ? "text-[#00c0ff] underline underline-offset-8 font-bold" : ""} onClick={() => setIsOpen(false)}>Contact</NavLink></li>
                </ul>
            </nav>
